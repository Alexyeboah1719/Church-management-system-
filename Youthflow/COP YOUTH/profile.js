...
async function loadProfileData() {
    ...
    try {
        ...
        document.getElementById('profileOccupation').textContent = member.occupation || 'Not specified';
        document.getElementById('profileBaptized').textContent = member.baptized ? (member.baptized === 'yes' ? 'Yes' : 'No') : 'Not specified';
...
async function populateEditForm() {
    ...
    try {
        ...
        // Set baptized radio button
        if (member.baptized) {
            const baptizedRadio = document.querySelector(`input[name="editBaptized"][value="${member.baptized}"]`);
            if (baptizedRadio) {
                baptizedRadio.checked = true;
            }
        }
    } catch (error) {
...
async function saveProfileChanges() {
    ...
    const baptized = document.querySelector('input[name="editBaptized"]:checked')?.value || '';
    
    // Validate required fields
    if (!name || !email || !phone || !location || !dateOfBirth || !occupation || !baptized) {
